...
const firebaseConfig = {
  apiKey: "AIzaSyAbj9hbMWxNjqZVDb748WnYO6CulC8Le4g", // Replace with your actual API Key
...
export default function App() {
    const [view, setView] = useState('loading'); // loading, students, logging, dashboard, settings
    const [students, setStudents] = useState([]);
    const [behaviors, setBehaviors] = useState([]);
    const [settings, setSettings] = useState([]);
    const [currentStudent, setCurrentStudent] = useState(null);
    const [currentUser, setCurrentUser] = useState(null); // Will hold { uid, role }
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
            <Header view={view} onNavigate={navigate} student={currentStudent} currentUser={currentUser} />
...
const Header = ({ view, onNavigate, student, currentUser }) => {
    ...
    return (
        <header className="bg-white shadow-md sticky top-0 z-40">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                ...
                <div className="text-xs text-gray-500 truncate" title={currentUser?.uid}>
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={generatePDF} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg">Generate PDF</button>
            </div>
